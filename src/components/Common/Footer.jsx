...
const Footer = () => {
    return (
        <footer className='border-t py-12'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4  lg-px-0'>
                <div>
                    ...
                    <p className='text-gray-500 mb-4 '>
                        Be the first to hear about new products, exclusive offers and latest news.
                    </p>
            ...
            {/* Footer Bottom */}
            <div className='container max-auto  mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
                <p className='text-gray-500 text-sm tracking-tighter text-center '>© 2025 , InstantKart. All Rights Reserved.</p>
            </div>
        </footer>
    )
}
